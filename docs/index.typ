...
- предметная область: "Обслуживание читателей в библиотеке" #linebreak(justify: true) ($624 mod 6 = 0$);
...
#figure(
  image("images/avl_tree.svg", width: 45%),
...
#figure(
  image("images/screen_readers.png", width: 80%),
...
#figure(
  image("images/screen_reader_add.png", width: 80%),
...
#figure(
  image("images/screen_reader_edit.png", width: 80%),
...
#figure(
  image("images/screen_readers_search.png", width: 80%),
  caption: "Активная строка поиска на экране «Читатели»"
) <screen_readers_search>

#figure(
  image("images/screen_readers_search_result.png", width: 80%),
  caption: "Поиск читателей по фрагменту ФИО «Нов»"
) <screen_readers_search_result>

#figure(
  image("images/screen_readers_search_ticket.png", width: 80%),
...
#figure(
  image("images/screen_books.png", width: 80%),
  caption: "Экран «Книги»"
) <screen_books>
...
#figure(
  image("images/screen_book_edit.png", width: 78%),
...
#figure(
  image("images/screen_books_search.png", width: 80%),
  caption: "Поиск книги по фрагменту названия «Ма»"
) <screen_books_search>

#figure(
  image("images/screen_books_search_author.png", width: 80%),
  caption: "Поиск книги по фрагменту автора «До»"
) <screen_books_search_author>

#figure(
  image("images/screen_books_search_cipher.png", width: 80%),
...
#figure(
  image("images/screen_loans_new.png", width: 80%),
...
#figure(
  image("images/screen_loans_added.png", width: 80%),
...
#figure(
  image("images/screen_settings.png", width: 80%),
